	...
	return (
		<div className='control-panel'>
			...
			<div className={`input ${allDays ? 'disabled' : ''}`}>
				...
				<input type='range' disabled={allDays} min={1} max={days} value={selectedDay} step={1} onChange={onSelectDay} />
			</div>
			<hr />
			<p>
				Data source: <a href='https://docs.mapbox.com/mapbox-gl-js/assets/earthquakes.geojson'>earthquakes.geojson</a>
			</p>
			<div className='source-link'>
				<a href='https://github.com/visgl/react-map-gl/tree/7.0-release/examples/heatmap' target='_new'>
					View Code ↗
				</a>
			</div>
		</div>
